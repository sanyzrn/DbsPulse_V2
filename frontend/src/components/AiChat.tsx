...
export function AiChat() {
  ...
  // دکمه برای همه دیده می‌شود، و دلیلِ در دسترس نبودن *داخل* پنجره گفته می‌شود.
  //
  // انتخابِ اولیه پنهان‌کردنِ دکمه بود («دکمه‌ای که تنها پاسخش در دسترس نیست
  // باشد، از نبودنِ دکمه بدتر است»). در عمل عکسش دیده شد: مدیری که تازه دستیار
  // را روشن کرده بود هیچ نشانه‌ای نمی‌دید و نمی‌دانست تنظیماتش گرفته یا نه.
  // یک جملهٔ صریح در پنجره، از یک دکمهٔ غایب بیشتر می‌گوید.
  return (
    <>
