...
class Capability(str, enum.Enum):
    ...
    #: تنظیمات دستیار هوشمند و تعیین اینکه چه کسی به آن دسترسی دارد.
    #:
    #: عمداً از `manage_modules` جدا شد: خاموش‌کردن یک بخش از سامانه با
    #: «کدام کاربر کلید API کدام سرویس بیرونی را دارد» یک جنس نیست. دومی هم
    #: هزینه دارد و هم داده را از سازمان بیرون می‌فرستد.
    manage_ai = "manage_ai"
