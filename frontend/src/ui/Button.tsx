...
const STYLES: Record<Variant, string> = {
  primary:
    "relative overflow-hidden rounded-xl bg-gradient-to-bl from-pulse-500 to-pulse-violet-600 px-5 py-2.5 text-sm font-semibold text-white shadow-md shadow-pulse-500/20 transition-all duration-200 hover:shadow-lg hover:shadow-pulse-500/30 hover:-translate-y-0.5 active:translate-y-0 active:shadow-md disabled:opacity-50 disabled:hover:translate-y-0 disabled:hover:shadow-md",
  secondary:
  ...
  danger:
    "rounded-xl bg-gradient-to-bl from-amber-500 to-amber-700 px-5 py-2.5 text-sm font-semibold text-white shadow-md shadow-amber-500/20 transition-all duration-200 hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 disabled:opacity-50",
